...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary text-black pt-[120px] h-[1200px] lg:h-[560px]">
      <div className="max-w-[1182px] mx-auto flex flex-col items-center justify-center lg:px-[160px] w-full px-4">

        <div className="flex flex-col lg:flex-row items-start justify-center w-full">

          <div className="footer_link_container mr-[74px] mb-[56px] lg:mb-0 items-center justify-center lg:items-start lg:justify-start w-full">
          ...
          <div className="footer_link_container order-first lg:order-last w-full">
            <h1 className="footer_link_title">SIGN UP</h1>

            <form className="text-sm-text mt-6 w-full">
              <p>Get the Latest Update and Offers</p>

              <input className='bg-transparent border-b border-b-t-orange pb-5 pt-8 pl-4 mb-8 placeholder:text-t-orange outline-none lg:w-[308px] w-full'
                type="text"
