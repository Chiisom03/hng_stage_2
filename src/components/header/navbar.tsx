        ...
        <nav className="w-full lg:border-b border-white bg-primary relative">
            <div className="flex bg-primary justify-between items-center py-[20px] lg:max-w-[1182px] lg:mx-auto mx-4">
                ...
                <div className="flex gap-x-4 items-center">
                    <ul className={`lg:mr-[60px] lg:flex lg:relative lg:top-0 absolute top-[72px] left-0 h-screen lg:h-min w-full flex-col lg:flex-row bg-[#FBFBFB] lg:bg-transparent lg:px-0 px-4 ${showMenu ? 'block' : 'hidden'}`}>
                        {navLinks.map((nav) => (
