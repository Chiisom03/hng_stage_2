    ...
    <div className="bg-primary w-full flex flex-col justify-center items-center h-[500px]">
      <div className="lg:max-w-[1182px] mx-auto w-full flex justify-center items-center space-x-[83px]">
        <div className="flex flex-col justify-between">
          <h1 className="lg:text-[92px] font-bold text-black">THE NEW RETRO</h1>
          <div>
            <p className="text-sm-text text-black max-w-[416px]">GET ALL EXQUISITE AND LUXERY JEWELRY TO YOUR CONFIDENCE GOING</p>
